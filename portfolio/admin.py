...
from .models import Licenciatura, UnidadeCurricular, Docente, Projeto, Tecnologia, TFC, Competencia, Formacao, MakingOf, Evento
...
class EventoAdmin(admin.ModelAdmin):
    list_display = ('nome', 'tipo', 'data', 'local')
    list_filter = ('tipo',)
    search_fields = ('nome',)